...
namespace MonteCarloOptionPricer.OptionModels
{
    public class EuropeanOption : IOption
    {
            ...
            SimulationMode simMode = SimulationMode.Plain)
        {
            ...
            var payoffs = BuildPayoffs(sim.Terminals, IsCall, Strike, simMode);
        ...
        private double ComputeDelta(SimulationParameters p, double basePrice, int seed, double eps)
        {
            ...
            var payoffs = BuildPayoffs(sim.Terminals, IsCall, Strike, bumped.SimMode);
        ...
        private double ComputeGamma(SimulationParameters p, double basePrice, int seed, double eps)
        {
            ...
            var payoffsUp = BuildPayoffs(simUp.Terminals, IsCall, Strike, p.SimMode);
            var payoffsDown = BuildPayoffs(simDown.Terminals, IsCall, Strike, p.SimMode);
        ...
        // === Utility ===
        private static List<double> BuildPayoffs(List<double> terminals, bool isCall, double strike, SimulationMode mode)
        {
